...
export const actions = {
    ...
    setFilter:                (filter:FilterT) => ({type: 'SET_FILTER', payload:filter})as const,
...
export const getUsers = (currentPage:number, pageSize:number, filter: FilterT): ThunkType => async (dispatch: DispatchType) => {
