...
const UsersList: React.FC<PropsTypes> = ({onFillterChanged, unfollow, follow, followingInProgress, pageSize, totalUsersCount, currentPage, onPageChanged, users, ...props}) => {
  return (
